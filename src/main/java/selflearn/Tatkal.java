...
public class Tatkal {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElementByXPath("//input[@placeholder='Journey Date(dd-mm-yyyy)*']").sendKeys("30-12-2019",Keys.ENTER);
		...
		driver.findElementByXPath("//label[text()='GENERAL']").click();
		
		Thread.sleep(3000);
		driver.findElementByXPath("//span[text()='TATKAL']").click();
		Thread.sleep(2000);
